  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 md:p-6">
      <h2 className="text-lg font-semibold text-gray-900 mb-4">
        {isOwner ? "Tiến độ học tập" : "Tiến độ học tập của người dùng"}
      </h2>
      {courses.length === 0 ? (
        <p className="text-gray-500">
          {isOwner ? "Bạn chưa đăng ký khóa học nào." : "Người dùng này chưa đăng ký khóa học nào."}
        </p>
      ) : (
              ...
              <div className="p-4 space-y-2">
                ...
                <div className="pt-2">
                  {isOwner ? (
                    ...
                    <Link href={ROUTES.COURSE_DETAIL(c.courseId)} className="inline-flex items-center px-3 py-1.5 bg-gray-600 text-white rounded hover:bg-gray-700 text-sm">
                      Xem khóa học
                    </Link>
                  )}
                </div>
